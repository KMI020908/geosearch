...
BIENCODER_INDEX_PATH = PROCESSED_DIR / "biencoder_index.pkl"
MODEL_DIR = ROOT_DIR / "models"
GLINER_MODEL = str(MODEL_DIR / "gliner_multi-v2.1")
BIENCODER_MODEL_RAW = str(MODEL_DIR / "biencoder" / "raw")
BIENCODER_MODEL = str(MODEL_DIR / "biencoder" / "processed")
PRIMARY_LANGUAGES = {
    "RU": "ru",
    "TR": "tr",
    "US": "en"
...
QUERY_SCHEMA: dict = {
    "query": pl.String,
    "geoname_ids": pl.List(pl.Int64),
    "language": pl.String,
    "source": pl.String,
    "template_index": pl.Int32,
}
